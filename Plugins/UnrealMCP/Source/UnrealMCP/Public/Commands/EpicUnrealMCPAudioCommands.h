...
private:
    ...
    TSharedPtr<FJsonObject> HandleSpawnAudioVolume(const TSharedPtr<FJsonObject>& Params);   // W1-H
    TSharedPtr<FJsonObject> HandleCreateDialogueWave(const TSharedPtr<FJsonObject>& Params); // W1-H
};
