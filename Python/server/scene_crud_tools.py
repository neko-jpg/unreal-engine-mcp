...
def scene_create(
    ...
    return _scene_syncd_error_response(
        _stc.call_scene_syncd("/scenes/create", payload), "scene_create"
    )
...
def scene_upsert_actor(
    ...
    return _scene_syncd_error_response(
        _stc.call_scene_syncd("/objects/upsert", payload), "scene_upsert_actor"
    )
...
def scene_upsert_actors(
    ...
    return _scene_syncd_error_response(
        _stc.call_scene_syncd("/objects/bulk-upsert", payload), "scene_upsert_actors"
    )
...
def scene_delete_actor(
    ...
    return _scene_syncd_error_response(
        _stc.call_scene_syncd("/objects/delete", payload), "scene_delete_actor"
    )
...
def scene_list_objects(
    ...
    return _scene_syncd_error_response(
        _stc.call_scene_syncd("/objects/list", payload), "scene_list_objects"
    )
...
def scene_list_scenes() -> Dict[str, Any]:
    ...
    return _scene_syncd_error_response(
        _stc.call_scene_syncd("/scenes/list", {}), "scene_list_scenes"
    )
...
def scene_list_snapshots(
    ...
    payload = {"scene_id": scene_id}
    return _scene_syncd_error_response(
        _stc.call_scene_syncd("/snapshots/list", payload), "scene_list_snapshots"
    )
...
def scene_snapshot_create(
    ...
    return _scene_syncd_error_response(
        _stc.call_scene_syncd("/snapshots/create", payload), "scene_snapshot_create"
    )
...
def scene_snapshot_restore(
    ...
    return _scene_syncd_error_response(
        _stc.call_scene_syncd("/snapshots/restore", payload), "scene_snapshot_restore"
    )
